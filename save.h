...
void SetSzWorkFromDt(uint16_t dt, int16_t iPlayer);  /* MEMORY_IO:0x8cfe */
int16_t FMarkFile(uint16_t dt, int16_t iPlayer, int16_t mdMark, int16_t f);  /* MEMORY_IO:0x904a */
...
int16_t FCreateFile(uint16_t dt, int16_t iPlayer, char *szForceName);  /* MEMORY_IO:0x8e16 */
