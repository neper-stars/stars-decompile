...
int16_t CchGetETA(uint16_t hdc, FLEET *lpfl, char *sz, int16_t iwp, int16_t fSmall);                                                                                       /* MEMORY_UTIL:0x3bc8 */
...
void DrawABunchOfStars(uint16_t hdc, RECT *prc);                                                                                                                           /* MEMORY_UTIL:0x5fe2 */
...
void DrawPlanetPrintDot(uint16_t hdc, int16_t x, int16_t y, int16_t iSize);                                                                                                /* MEMORY_UTIL:0x7e44 */
