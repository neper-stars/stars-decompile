...
int16_t BattlePlansDlg(uint16_t hwnd, uint16_t message, uint16_t wParam, int32_t lParam);  /* PASCAL */  /* MEMORY_BATTLE:0x0652 */
int16_t NewPlanNameDlg(uint16_t hwnd, uint16_t message, uint16_t wParam, int32_t lParam);  /* PASCAL */  /* MEMORY_BATTLE:0x04ce */
...
int16_t RelationsDlg(uint16_t hwnd, uint16_t message, uint16_t wParam, int32_t lParam);  /* PASCAL */  /* MEMORY_BATTLE:0x0088 */
